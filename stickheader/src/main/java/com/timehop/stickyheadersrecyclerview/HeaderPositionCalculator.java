...
public class HeaderPositionCalculator {
     ...
     */
    public boolean hasStickyHeader(View itemView, int orientation, int position,int len) {
        if (position<=0){
            return false;
        }
        position-=1;
     ...
     */
    public boolean hasNewHeader(int position, boolean isReverseLayout,int len) {
        if (position<=0){
            return false;
        }
        position-=1;
    ...
    private boolean isStickyHeaderBeingPushedOffscreen(RecyclerView recyclerView, View stickyHeader) {
        ...
        if (firstViewUnderHeaderPosition > 0 && hasNewHeader(firstViewUnderHeaderPosition, isReverseLayout,recyclerView.getChildCount())) {
