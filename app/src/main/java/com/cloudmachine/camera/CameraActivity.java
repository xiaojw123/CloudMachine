...
import com.cloudmachine.widget.PreviewBorderView;
...
//    private LinearLayout mLinearLayout;
    ...
    public static final  String TYPE_PIC_FRONT="type_pic_front";
    public static final  String TYPE_PIC_BG="type_pic_bg";
    ...
    private void initIntent() {
        mIntent = getIntent();
        type = mIntent.getStringExtra(PIC_TYPE);
        if (filePath == null) {
    ...
    private void initLayoutParams() {
        take = (ImageView) findViewById(R.id.take_img);
...
//        mLinearLayout = (LinearLayout) findViewById(R.id.linearlaout);
        ...
        cameraImg= (ImageView) findViewById(R.id.camera_back_img);
