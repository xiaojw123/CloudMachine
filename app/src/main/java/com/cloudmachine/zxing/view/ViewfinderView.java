...
package com.cloudmachine.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        labelTextSize = array.getFloat(R.styleable.ViewfinderView_label_text_size, DensityUtil.dip2px(context,12));
    ...
    private void drawTextInfo(Canvas canvas, Rect frame) {
        ...
        canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + CORNER_RECT_HEIGHT + DensityUtil.dip2px(getContext(), 10), paint);
    }
