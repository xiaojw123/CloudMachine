package com.cloudmachine.zxing.activity;
...
import com.cloudmachine.zxing.camera.CameraManager;
import com.cloudmachine.zxing.decoding.CaptureActivityHandler;
import com.cloudmachine.zxing.decoding.InactivityTimer;
import com.cloudmachine.zxing.decoding.RGBLuminanceSource;
import com.cloudmachine.zxing.view.ViewfinderView;
 ...
 * @author Ryan.Tang
 */
public class CaptureActivity extends BaseAutoLayoutActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lampImg= (ImageView) findViewById(R.id.viewfinder_lamp_img);
    ...
    public void handleLampLight() {
        ...
        if (camera != null) {
            ...
            if (Camera.Parameters.FLASH_MODE_OFF.equals(parameters.getFlashMode())) {
                lampImg.setImageResource(R.drawable.icon_lamp_open);
                parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
                camera.setParameters(parameters);
            } else if (Camera.Parameters.FLASH_MODE_TORCH.equals(parameters.getFlashMode())) {
                lampImg.setImageResource(R.drawable.icon_lamp_close);
