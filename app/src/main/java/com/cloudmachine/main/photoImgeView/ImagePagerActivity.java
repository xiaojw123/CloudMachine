...
//					urls[i] = "file://"+(dataList.get(i).imagePath!=null?dataList.get(i).imagePath:dataList.get(i).thumbnailPath);
   ...
   private void initView(Bundle savedInstanceState){
	...
	private class ImagePagerAdapter extends FragmentStatePagerAdapter {
		...
		@Override
		public int getCount() {
			Constants.MyLog("shul:"+(fileList == null ? 0 : fileList.size()));
	...
	private void initTitleLayout() {
		...
		if(animType == 2){
			title_layout.setTitle("");
		}else if(animType == 1){
			title_layout.setRightImage(R.drawable.bg_btn_delet,
					new OnClickListener() {
			...
			if(isCanDelete){
				title_layout.setRightImage(R.drawable.plugin_camera_choosed,
						new OnClickListener() {
