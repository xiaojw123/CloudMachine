...
//    protected <E> void decodeJson(String result, Handler handler, int successCode) {
//        if (isNeedCache && isNetData) {
//            isNetData = false;
//            Constants.setObjcet2File(result, cacheName);
//        }
//        Gson gson = new Gson();
//        BaseBO<E> baseBO = gson.fromJson(result, new TypeToken<BaseBO<E>>() {
//        }.getType());
//        if (baseBO != null) {
//            Message msg = Message.obtain();
//            if (baseBO.getCode() == SUCCESS) {
...
//
//
//    protected <E> void decodeJson(String result, Handler handler, int successCode, int failedCode) {
//        if (isNeedCache && isNetData) {
//            isNetData = false;
//            Constants.setObjcet2File(result, cacheName);
//        }
