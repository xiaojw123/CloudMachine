...
public class RegisterAsync extends ATask {
	...
	public RegisterAsync(String mobile,String pwd,String nickname,Context context,Handler handler){
	...
	protected String doInBackground(String... params) {
		...
		String result = null;
		try {
			result = httpRequest.post(URLs.USER_URL, list);
			return result;
		} catch (Exception e) {
			e.printStackTrace();
			return null;
