...
public class updateDeviceInfoByKeyAsync extends ATask {

	private Context context;
	private Handler handler;
	private int type;
	
	public updateDeviceInfoByKeyAsync(Context context,Handler handler){
	...
	protected String doInBackground(String... params) {
		...
		String result = null;
		try {
				result = httpRequest.post(Constants.URL_UPDATEDEVICEINFOBYKEY, list);
			return result;
		} catch (Exception e) {
			e.printStackTrace();
			return null;
