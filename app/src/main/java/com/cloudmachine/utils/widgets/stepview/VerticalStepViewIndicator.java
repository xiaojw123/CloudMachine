package com.cloudmachine.utils.widgets.stepview;
...
public class VerticalStepViewIndicator extends View
{
    ...
    private Paint mCompletedPaint;//完成paint      definition mCompletedPaint   ContextCompat.getColor(getContext(), R.color.uncompleted_color);
    private int mUnCompletedLineColor = getContext().getResources().getColor(R.color.uncompleted_color);//定义默认未完成线的颜色  definition mUnCompletedLineColor
    ...
    private void init()
    {
        ...
        //ContextCompat.getDrawable(getContext(), R.drawable.attention)
        //ContextCompat.getDrawable(getContext(), R.drawable.default_icon)
        mCompleteIcon = getContext().getResources().getDrawable(R.drawable.complted);//已经完成的icon
        mAttentionIcon = getContext().getResources().getDrawable(R.drawable.attention);//正在进行的icon
        mDefaultIcon = getContext().getResources().getDrawable(R.drawable.default_icon);;//未完成的icon
