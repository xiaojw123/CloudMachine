...
public class ToastUtils {
    ...
    public static void error(String msg,boolean withIcon) {
        Toasty.error(MyApplication.getInstance(), msg, Toast.LENGTH_SHORT, withIcon).show();
    }

    public static void success(String msg,boolean withIcon) {
        Toasty.success(MyApplication.getInstance(), msg, Toast.LENGTH_SHORT, withIcon).show();
    }

    public static void info(String msg,boolean withIcon) {
        Toasty.info(MyApplication.getInstance(), msg, Toast.LENGTH_SHORT, withIcon).show();
    }

    public static void warning(String msg,boolean withIcon) {
        Toasty.warning(MyApplication.getInstance(), msg, Toast.LENGTH_SHORT, withIcon).show();
    }

    public static void normal(String msg,boolean withIcon) {
        Toasty.normal(MyApplication.getInstance(), msg, Toast.LENGTH_SHORT).show();
    }

    public static void normal(String msg, boolean withIcon, Drawable icon ) {
        Toasty.normal(MyApplication.getInstance(), msg, Toast.LENGTH_SHORT,icon,withIcon).show();
    }
}
