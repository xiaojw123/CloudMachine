...
package com.cloudmachine.chart.data;
...
import com.cloudmachine.chart.utils.ColorTemplate;
...
public abstract class DataSet<T extends Entry> {
    ...
    protected boolean mValuesColorsSameRect = false;
    ...
    public void setRound (float rx, float ry){
    	this.rx = rx;
    	this.ry = ry;
    }
    ...
    public void setValuesColorsSameRect(boolean b){
    	mValuesColorsSameRect = b;
    }
    
    public boolean getValuesColorsSameRect(){
    	return mValuesColorsSameRect;
    }
