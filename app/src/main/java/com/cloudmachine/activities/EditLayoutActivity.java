...
import com.cloudmachine.struc.MachineModelInfo;
...
public class EditLayoutActivity extends BaseActivity implements Callback, OnClickListener,OnItemClickListener{
	...
	private RootNodesInfo rootNodesInfo;
	...
	private void initTitleLayout(){
		...
		title_layout.setTitle(titleText);
