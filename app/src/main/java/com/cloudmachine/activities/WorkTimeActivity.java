...
public class WorkTimeActivity extends BaseAutoLayoutActivity implements OnClickListener,Callback, OnSeekBarChangeListener,
...
//	private ScanningWTInfo[] wtInfo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mc_worktime);
		this.mContext = this;
...
//	        dailyChart.setMaxVisibleValueCount(60);
	        ...
	        xl.setPosition(XAxisPosition.TOP_INSIDE);
