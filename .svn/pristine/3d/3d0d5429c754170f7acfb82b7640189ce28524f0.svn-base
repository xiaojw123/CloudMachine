package com.cloudmachine.utils.locatecity;
import java.io.File;
...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.cloudmachine/databases/";
	/*
	 * //如果你想把数据库文件存放在SD卡的话 private static String DB_PATH =
	 * android.os.Environment.getExternalStorageDirectory().getAbsolutePath() +
	 * "/arthurcn/drivertest/packfiles/";
	 */
	private static String DB_NAME = "cloudm_cities.db";
	private static String ASSETS_NAME = "cloudm_cities.db";
