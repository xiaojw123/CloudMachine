...
public class NewTitleView extends RelativeLayout {
    ...
    private TextView title_name,title_name_remarks;
    ...
    private void initView(Context context) {
        ...
        inflater.inflate(R.layout.layout_title_new, this);

        title_name = (TextView)findViewById(R.id.title_name);
        title_name_remarks = (TextView)findViewById(R.id.title_name_remarks);
    ...
    public void setTitleRemarks(String remarks){
    	if(null != remarks && !remarks.equals("")){
    		if(remarks.equals("")){
    			title_name_remarks.setVisibility(View.GONE);
    		}else{
    			title_name_remarks.setVisibility(View.VISIBLE);
        		title_name_remarks.setText(remarks);
    		}
    ...
    public void setLeftImage(int srcId,OnClickListener listener){
    	if(srcId != -1)
    		title_left_button.setImageResource(srcId);
    	if(listener != null){
    ...
    //设置左边图片和文字的点击事件
    public void setLeftLayout(int imageId,String leftText,OnClickListener listener){
    	if(imageId != -1)
    		title_left_button.setImageResource(imageId);
    	if(listener != null){
//    		left_layout.setOnClickListener(listener);
//    		title_left_button.setOnClickListener(listener);
    		left_layout.setOnClickListener(listener);
