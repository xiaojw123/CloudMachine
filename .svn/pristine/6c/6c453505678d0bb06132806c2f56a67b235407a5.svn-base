...
public class UpdatePwdAsync extends ATask {
	...
	public UpdatePwdAsync(String oldPassword,String newPassword,String rePassword,Context context,Handler handler){
	...
	protected String doInBackground(String... params) {
		...
		String result = null;
		try {
			result = httpRequest.post(URLs.UPDATEPWD_URL, list);
			return result;
		} catch (Exception e) {
			e.printStackTrace();
			return null;
